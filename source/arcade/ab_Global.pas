...
procedure VectorToSphericalAngles(Vector: TVector3D; var LongitudeDegrees, PolarAngleDegrees: Double); // @addr 0x4EC664 @ida "void __usercall $name(TVector3D *Vector@<eax>, double *LongitudeDegrees@<edx>, double *PolarAngleDegrees@<ecx>);" @note "Requires a nonzero vector."
procedure AdvanceSphericalBearingState(var LongitudeDegrees, PolarAngleDegrees, BearingDegrees: Double; SphereRadius, ArcDistance: Double); // @addr 0x4EC71C @ida "void __userpurge $name(double *LongitudeDegrees@<eax>, double *PolarAngleDegrees@<edx>, double *BearingDegrees@<ecx>, double SphereRadius@<^8>, double ArcDistance@<^0>);" @note "Negative distance moves backward. Longitude and bearing pass through Single precision when wrapped."
...
procedure ComputeSphericalBearingAndDistance(var BearingDeltaDegrees, Distance: Double; SourceLongitudeDegrees, SourcePolarAngleDegrees, SourceBearingDegrees, TargetLongitudeDegrees, TargetPolarAngleDegrees, SphereRadius: Double); // @addr 0x4ECC6C @ida "void __userpurge $name(double *BearingDeltaDegrees@<eax>, double *Distance@<edx>, double SourceLongitudeDegrees@<^40>, double SourcePolarAngleDegrees@<^32>, double SourceBearingDegrees@<^24>, double TargetLongitudeDegrees@<^16>, double TargetPolarAngleDegrees@<^8>, double SphereRadius@<^0>);" @note "Bearing is relative to SourceBearingDegrees; coincident points return zero bearing delta and distance."
procedure ComputeSphericalDistance(var Distance: Double; SourceLongitudeDegrees, SourcePolarAngleDegrees, UnusedSourceBearingDegrees, TargetLongitudeDegrees, TargetPolarAngleDegrees, SphereRadius: Double); // @addr 0x4ECEFC @ida "void __userpurge $name(double *Distance@<eax>, double SourceLongitudeDegrees@<^40>, double SourcePolarAngleDegrees@<^32>, double UnusedSourceBearingDegrees@<^24>, double TargetLongitudeDegrees@<^16>, double TargetPolarAngleDegrees@<^8>, double SphereRadius@<^0>);"
function GetSphericalBearingAndDistance(Source, Target: TSphericalBearingState): TSphericalBearingDistance; // @addr 0x4ED04C @ida "void __usercall $name(TSphericalBearingState *Source@<eax>, TSphericalBearingState *Target@<edx>, TSphericalBearingDistance *Result@<ecx>);" @note "Uses the current sphere radius; ignores Target.BearingDegrees."
...
function IsDepthBeforeSphereHorizon(ProjectedDepth: Double): Boolean; // @addr 0x4ED3C0 @ida "bool __userpurge $name@<al>(double ProjectedDepth@<^0>);" @note "Compares against the horizon depth set by UpdateSphereProjectionMetrics."
...
var Permutations: array[0..3] of Integer;
  ...
  procedure DecomposeMatrix4DLu(var Matrix: TMatrix4D; var PermutationSign: Double); // @addr 0x4EDA20 @ida "void __usercall $name(TMatrix4D *Matrix@<eax>, double *PermutationSign@<edx>, void *ParentFrame@<^0>);"
