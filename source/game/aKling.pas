...
var
  ...
  function RandomEquipmentSize(BaseSize, MinimumSizeIndex, MaximumSizeIndex: Integer): Integer;
  begin
    Result :=
        RandomInteger(
  ...
  function SizeForKind(BaseSize: Integer): Integer;
  begin
    Result :=
        RandomEquipmentSize(
            BaseSize,
  ...
  function RandomTuning(MinimumColumn, MaximumColumn: Integer): Integer;
  var
    A, B: Integer;
  begin
    A :=
  ...
  function InterpolatedTuning(MinimumColumn, MaximumColumn: Integer): Integer;
  begin
    Result :=
        Round(
            RemapClamped(
...
var
  ...
  procedure SpawnReinforcement(OrderData: Integer);
  begin
...
var
  ...
  function NonDominatorDistanceIndex(Star: TStar): Integer;
  var
    I: Integer;
  begin
    Result := 1000;
  ...
  function OtherSeriesDistanceIndex(Star: TStar): Integer;
  var
    I: Integer;
    OtherStar: TStar;
  begin
  ...
  procedure ChooseAction;
    ...
    function TargetIsNotTerron: Boolean;
    begin
      Result := True;
