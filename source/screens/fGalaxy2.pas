...
type
  ...
  TfGalaxy2 = class(TMessageLoopGIWithMainPanel)
    ...
    JumpHintAnimationState: Integer;
...
begin
  ...
  begin
    ...
    Galaxy.CheckIntegrityChecksum(152);
...
var
  ...
  procedure AccumulateShip; cdecl;
  var
    Faction: WideString;
  begin
  ...
  function SeriesColor: WideString;
  begin
    Result := '';
    case Series of
