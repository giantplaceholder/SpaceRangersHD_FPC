  ...
  begin
    ...
    begin
      ...
      if not (State in [2, 3]) then
        FrameIndex := Random(Animation.SequenceFrameCount - 1);
...
var
  ...
  function ParseRuinsPoint(PointText: WideString): TPoint;
  begin
  ...
  function ParseRuinsEnabled(Name: WideString): Boolean;
  begin
    if (Name = 'Yes')
        or (Name = 'yes')
        or (Name = 'True')
